...
public class Ristorante {
    ...
    public categoriaRistorante categoria;
    ...
    public Ristorante(String path) {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                if(counter > 0) {
                    ...
                    if(attributo.equals("partita_iva")) {
                        ...
                        this.sede = valore;
                    } else if(attributo.equals("categoria")) {
                        //handling categoria

                        if(valore.equals("italiano")) {
                            this.categoria = categoriaRistorante.ITALIANO;
                        } else if(valore.equals("pizzeria")) {
                            this.categoria = categoriaRistorante.PIZZERIA;
                        } else if(valore.equals("etnico")) {
                            this.categoria = categoriaRistorante.ETNICO;
                        } else {
                            System.out.println("Errore: categoria non riconosciuta");
                            return;
                        }
            ...
            if(this.partitaIva == null || this.sede == null || this.categoria == null || this.inAttivitaDal == 0) {
